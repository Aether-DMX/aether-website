...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0a0a0c] border-t border-[#1f1f24]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-[#71717a] mb-6">
              AI-powered architectural lighting control that runs on real-world hardware.
            </p>
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-[#1f1f24]">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-xs text-[#71717a]">
              © {new Date().getFullYear()} Aether DMX. All rights reserved.
            </p>
            <p className="text-xs text-[#71717a]">
              Built for lighting professionals who demand more.
            </p>
          </div>
        </div>
      </div>
