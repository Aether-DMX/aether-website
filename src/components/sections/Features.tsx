...
const features = [
  {
    ...
    description: 'Describe the look you want in plain language; Aether assists with patch and scene generation.',
    icon: (
  ...
  },
  {
    ...
    description: 'Use ESP32-based DMX nodes and standard networking to build flexible, scalable systems.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
