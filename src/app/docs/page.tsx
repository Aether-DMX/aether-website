...
function getDocIcon(title: string) {
  for (const key of Object.keys(docIcons)) {
    if (key !== 'default' && title.includes(key)) return docIcons[key];
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-[#71717a] leading-relaxed">
              Everything you need to set up, configure, and get the most out of AETHER DMX.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-[#0a0a0c] border border-[#1f1f24] rounded-xl p-8">
              ...
              <a
                href="mailto:hello@aetherdmx.com"
                className="inline-flex items-center gap-2 btn-secondary"
              >
                hello@aetherdmx.com
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
