...
export async function SimpleDocsList() {
...
export default async function DocsPage() {
  ...
  return (
    <div className="min-h-screen pt-16">
      ...
      <section className="py-16 lg:py-24 bg-[#0a0a0c]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">Available Documentation</h2>
          <p className="text-[#71717a] mb-8 max-w-2xl">
            Get started with our guides and references. Each doc is a comprehensive resource to help you make the most of Aether DMX.
          </p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {docs.map((doc) => (
              <Link
                key={doc.slug}
                href={`/docs/${doc.slug}`}
                className="group bg-[#111114] border border-[#1f1f24] rounded-xl p-6 hover:border-[#00d4ff]/50 transition-all duration-300 hover:shadow-lg hover:shadow-[#00d4ff]/10"
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="w-12 h-12 rounded-lg bg-[#1f1f24] group-hover:bg-[#00d4ff]/20 flex items-center justify-center text-[#00d4ff] transition-colors">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                  </div>
                  <span className="text-xs font-medium px-2 py-1 rounded bg-[#00d4ff]/20 text-[#00d4ff]">
                    Available
                  </span>
                </div>
                <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-[#00d4ff] transition-colors">{doc.meta.title}</h3>
                <p className="text-sm text-[#71717a]">{doc.meta.description || 'Learn more about this topic in our comprehensive guide.'}</p>
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 lg:py-24 bg-[#111114]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[#71717a] mb-8 max-w-2xl">
            We&apos;re actively building more documentation. Beta users get early access as new guides are published.
          </p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {plannedSections.map((section) => (
              <div
                key={section.title}
                className="bg-[#0a0a0c] border border-[#1f1f24] rounded-xl p-6 opacity-60"
              >
                <div className="flex items-start justify-between mb-4">
      ...
      <section className="py-16 lg:py-24 bg-[#0a0a0c]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8">
            {/* Discord */}
            <div className="bg-[#111114] border border-[#1f1f24] rounded-xl p-8">
